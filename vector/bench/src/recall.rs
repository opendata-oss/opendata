...
const SIFT10M: Dataset = Dataset {
    ...
    ground_truth_file: "bigann/gnd/idx_10M.ivecs",
    split_threshold: 1500,
    merge_threshold: 500,
    nprobe: 100,
...
const SIFT50M: Dataset = Dataset {
    ...
    base_file: "bigann/bigann_base.bvecs",
    query_file: "bigann/bigann_query.bvecs",
    ground_truth_file: "bigann/gnd/idx_50M.ivecs",
    split_threshold: 1500,
    merge_threshold: 500,
    nprobe: 100,
    format: VecFormat::Bvecs,
...
const SIFT100M: Dataset = Dataset {
    ...
    base_file: "bigann/bigann_base.bvecs",
    query_file: "bigann/bigann_query.bvecs",
    ground_truth_file: "bigann/gnd/idx_100M.ivecs",
    split_threshold: 1500,
    merge_threshold: 500,
    nprobe: 100,
    format: VecFormat::Bvecs,
...
const SIFT1B: Dataset = Dataset {
    ...
    base_file: "bigann/bigann_base.bvecs",
    query_file: "bigann/bigann_query.bvecs",
    ground_truth_file: "bigann/gnd/idx_1B.ivecs",
    split_threshold: 1500,
    merge_threshold: 500,
    nprobe: 100,
    format: VecFormat::Bvecs,
