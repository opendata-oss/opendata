...
impl QueryEngine {
    ...
    pub async fn search_exact_nprobe(
        ...
        let mut sorted_lists = self
            .load_and_score(&centroid_ids, &query.vector, self.storage.clone())
            .await?;
        ...
        self.resolve_top_k(sorted_lists, query.limit, self.storage.as_ref())
            .await
    }
...
mod tests {
    ...
    use crate::model::{Config, Query, Vector};
    use crate::serde::collection_meta::DistanceMetric;
