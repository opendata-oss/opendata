//! Error types for OpenData Vector operations.
//!
//! This module defines [`Error`], the primary error type for all vector
...
/// interacting with the vector database, including storage failures, encoding
/// issues, and invalid input.
///
/// # Error Categories
///
...
pub enum Error {
    ...
    /// such as bad dimensions, unknown fields, or malformed vectors.
    InvalidInput(String),
