module github.com/opendata-oss/opendata/otel-exporter

go 1.26.1

replace github.com/opendata-oss/opendata/ingest-bindings/go => ../ingest-bindings/go

require (
	github.com/opendata-oss/opendata/ingest-bindings/go v0.0.0
